...
.NOTES
    ...
    CIS Windows 10 Stand-alone v3.0.0: 18.4.1 (L1)
...
.USAGE
    PS C:\> .\CIS_18.4.1_RPCPacketPrivacyIncoming_Enabled.ps1
#>

# Define reg path and key
$registryPath = "HKLM:\SYSTEM\CurrentControlSet\Control\Print"
$registryKey = "RpcAuthnLevelPrivacyEnabled"
...
Write-Host "'Configure RPC packet level privacy setting for incoming connections' is set to 'Enabled'"

...
.NOTES
    ...
    CIS Windows 10 Stand-alone v3.0.0: 18.9.33.6.5 (L1)
...
.USAGE
    ...
    Example syntax:
    PS C:\> .\CIS_18.9.33.6.5_RequirePasswordOnWakeOnBattery_Enabled.ps1
#>
...
Write-Host "'Require a password when a computer wakes (on battery)' is set to 'Enabled'"

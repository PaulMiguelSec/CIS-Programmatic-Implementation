...
$registryKey = "NoWarningNoElevationOnInstall"
...
Write-Host "'Point and Print Restrictions: When installing drivers for a new connection' is set to 'Enabled: Show warning and elevation prompt'"

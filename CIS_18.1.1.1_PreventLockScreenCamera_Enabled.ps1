<#
.SYNOPSIS
    Ensure 'Restrict 'Prevent enabling lock screen camera' is set to 'Enabled'
...
.NOTES
    ...
    CIS Windows 10 Stand-alone v3.0.0: 18.1.1.1 (L1)
...
.USAGE
    PS C:\> .\CIS_18.1.1.1_PreventLockScreenCamera_Enabled.ps1
#>
...
Write-Host "'Prevent enabling lock screen camera' is set to 'Enabled'"

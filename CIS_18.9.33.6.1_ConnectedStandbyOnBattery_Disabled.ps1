...
.NOTES
    ...
    CIS Windows 10 Stand-alone v3.0.0: 18.9.33.6.1 (L1)
...
.USAGE
    ...
    Example syntax:
    PS C:\> .\CIS_18.9.33.6.1_ConnectedStandbyOnBattery_Disabled.ps1
#>
...
Write-Host "'Allow network connectivity during connected-standby (on battery)' is set to 'Disabled'"

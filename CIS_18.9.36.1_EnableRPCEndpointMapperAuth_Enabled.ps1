...
.NOTES
    ...
    CIS Windows 10 Stand-alone v3.0.0: 18.9.36.1 (L1)
...
.USAGE
    ...
    Example syntax:
    PS C:\> .\CIS_18.9.36.1_EnableRPCEndpointMapperAuth_Enabled.ps1
#>
...
Write-Host "Ensure 'Enable RPC Endpoint Mapper Client Authentication' is set to 'Enabled'"

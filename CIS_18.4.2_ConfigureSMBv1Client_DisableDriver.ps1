...
.NOTES
    ...
    Plugin IDs      : N/A
    CIS Control:    : 4.8
    CIS Windows 10 Stand-alone v3.0.0: 18.4.2 (L1)
...
.USAGE
    PS C:\> .\CIS_18.4.2_ConfigureSMBv1Client_DisableDriver.ps1
#>
...
# Set reg key
Set-ItemProperty -Path $registryPath -Name $registryKey -Value 4

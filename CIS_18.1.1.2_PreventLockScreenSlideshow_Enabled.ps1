...
.NOTES
    ...
    CIS Windows 10 Stand-alone v3.0.0: 18.1.1.2 (L1)
...
.USAGE
    PS C:\> .\CIS_18.1.1.2_PreventLockScreenSlideshow_Enabled.ps1
#>
...
Write-Host "'Prevent enabling lock screen slide show' is set to 'Enabled'"

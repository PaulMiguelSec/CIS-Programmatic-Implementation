...
.NOTES
    ...
    CIS Windows 10 Stand-alone v3.0.0: 18.4.5 (L1)
...
.USAGE
    PS C:\> .\CIS_18.4.5_EnableSEHOP_Enabled.ps1
#>
...
Write-Host "'Enable Structured Exception Handling Overwrite Protection (SEHOP)' is set to 'Enabled'"

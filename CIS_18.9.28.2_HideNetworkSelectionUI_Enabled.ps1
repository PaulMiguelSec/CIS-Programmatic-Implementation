...
.NOTES
    ...
    Plugin IDs      : N/A
    CIS Control:    : 4.1
    CIS Windows 10 Stand-alone v3.0.0: 18.9.28.2 (L1)
...
.USAGE
    ...
    Example syntax:
    PS C:\> .\CIS_18.9.28.2_HideNetworkSelectionUI_Enabled.ps1 
#>
...
Write-Host "'Do not display network selection UI' is set to 'Enabled'"
